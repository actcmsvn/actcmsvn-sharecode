...
// Envato id
$sharecode_item_id = 20201709;

// Product Url from codecanyon
$productUrl = 'https://actcms.work/item/worksuite-project-management-system/20201709?ref=dezhongvn';
...
return [
    ...
    'sharecode_item_id' => $sharecode_item_id,

    'sharecode_product_name' => $product,

    'sharecode_product_url' => $productUrl,
