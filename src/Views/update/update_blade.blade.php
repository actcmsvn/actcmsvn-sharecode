@php($sharecodeUpdateCompanySetting = \Actcmsvn\Sharecode\Functions\SharecodeUpdate::companySetting())

@if(!is_null($sharecodeUpdateCompanySetting->supported_until))
    <div class="col-md-12" id="support-div">
        @if(\Carbon\Carbon::parse($sharecodeUpdateCompanySetting->supported_until)->isPast())
            <div class="col-md-12 alert alert-danger ">
                <div class="col-md-6">
                    Your support has been expired on <b><span
                                id="support-date">{{\Carbon\Carbon::parse($sharecodeUpdateCompanySetting->supported_until)->format('d M, Y')}}</span></b>
                </div>
                <div class="col-md-6 text-right">
                    <a href="{{ config('actcmsvn_sharecode.sharecode_product_url') }}" target="_blank"
...
@php($updateVersionInfo = \Actcmsvn\Sharecode\Functions\SharecodeUpdate::updateVersionInfo())
