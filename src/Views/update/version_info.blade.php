@php($updateVersionInfo = \Actcmsvn\Shaecode\Functions\EnvatoUpdate::updateVersionInfo())
@php($envatoUpdateCompanySetting = \Actcmsvn\Shaecode\Functions\EnvatoUpdate::companySetting())
<div class="table-responsive">
    ...
    <table class="table table-bordered">
        ...
        @if(!is_null($envatoUpdateCompanySetting->purchase_code))
            <tr>
                <td>Shaecode Purchase code <span
